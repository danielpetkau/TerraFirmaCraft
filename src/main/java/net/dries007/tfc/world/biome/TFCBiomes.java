...
public final class TFCBiomes
{
    ...
    public static final BiomeExtension ACTIVE_OCEANIC_SHIELD_VOLCANO = register("active_oceanic_shield_volcano", builder().heightmap(seed -> BiomeNoise.activeShieldVolcano(seed, 55, 180, BiomeNoise.activeHotSpots(seed))).surface(ActiveShieldVolcanoSurfaceBuilder.INSTANCE).volcanoes(4, 0, 20, 28, true).spawnable().type(RiverBlendType.CAVE));
    public static final BiomeExtension DORMANT_OCEANIC_SHIELD_VOLCANO = register("dormant_oceanic_shield_volcano", builder().heightmap(seed -> BiomeNoise.dormantShieldVolcano(seed, 55, 165, BiomeNoise.dormantHotSpots(seed))).surface(ActiveShieldVolcanoSurfaceBuilder.INSTANCE).spawnable().type(RiverBlendType.CAVE));
    public static final BiomeExtension EXTINCT_OCEANIC_SHIELD_VOLCANO = register("extinct_oceanic_shield_volcano", builder().heightmap(seed -> BiomeNoise.dormantShieldVolcano(seed, 55, 120, BiomeNoise.extinctHotSpots(seed))).surface(ActiveShieldVolcanoSurfaceBuilder.INSTANCE).spawnable().type(RiverBlendType.CAVE));
    public static final BiomeExtension ANCIENT_OCEANIC_SHIELD_VOLCANO = register("ancient_oceanic_shield_volcano", builder().heightmap(seed -> BiomeNoise.dormantShieldVolcano(seed, 55, 75, BiomeNoise.ancientHotSpots(seed))).surface(ActiveShieldVolcanoSurfaceBuilder.INSTANCE).spawnable().type(RiverBlendType.CAVE));

    public static final BiomeExtension ACTIVE_CONTINENTAL_SHIELD_VOLCANO = register("active_continental_shield_volcano", builder().heightmap(seed -> BiomeNoise.activeShieldVolcano(seed, 90, 200, BiomeNoise.activeHotSpots(seed))).surface(ActiveShieldVolcanoSurfaceBuilder.INSTANCE).volcanoes(4, 0, 20, 28, true).spawnable().type(RiverBlendType.CAVE));
    public static final BiomeExtension DORMANT_CONTINENTAL_SHIELD_VOLCANO = register("dormant_continental_shield_volcano", builder().heightmap(seed -> BiomeNoise.dormantShieldVolcano(seed, 90, 185, BiomeNoise.dormantHotSpots(seed))).surface(ActiveShieldVolcanoSurfaceBuilder.INSTANCE).spawnable().type(RiverBlendType.CAVE));
    public static final BiomeExtension EXTINCT_CONTINENTAL_SHIELD_VOLCANO = register("extinct_continental_shield_volcano", builder().heightmap(seed -> BiomeNoise.weatheredShieldVolcano(seed, 90, 160, BiomeNoise.extinctHotSpots(seed))).surface(ActiveShieldVolcanoSurfaceBuilder.INSTANCE).spawnable().type(RiverBlendType.CAVE));
    public static final BiomeExtension ANCIENT_CONTINENTAL_SHIELD_VOLCANO = register("ancient_continental_shield_volcano", builder().heightmap(seed -> BiomeNoise.weatheredShieldVolcano(seed, 90, 130, BiomeNoise.ancientHotSpots(seed))).surface(ActiveShieldVolcanoSurfaceBuilder.INSTANCE).spawnable().type(RiverBlendType.CAVE));
