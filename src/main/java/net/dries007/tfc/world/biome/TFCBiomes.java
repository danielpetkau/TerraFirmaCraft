...
public final class TFCBiomes
{
    ...
    public static final BiomeExtension ICE_SHEET_MOUNTAINS = register("ice_sheet_mountains", builder().heightmap(seed -> BiomeNoise.glacialMontaneIceSurface(seed).max(BiomeNoise.glacialCirques(seed).addConstant(44)).max(BiomeNoise.glacialCirquesIceSurface(seed).addConstant(44))).surface(IceSheetSurfaceBuilder.ICE_SHEET_MOUNTAINS).spawnable().type(RiverBlendType.CAVE).noSandyRiverShores());
    ...
    public static final BiomeExtension ICE_SHEET_EDGE = register("ice_sheet_edge", builder().heightmap(BiomeNoise::glacialBase).surface(IceSheetSurfaceBuilder.NORMAL).spawnable().type(RiverBlendType.TALL_CANYON).noSandyRiverShores().shore());
    public static final BiomeExtension ICE_SHEET_MOUNTAINS_EDGE = register("ice_sheet_mountains_edge", builder().heightmap(seed -> BiomeNoise.glacialCirques(seed).addConstant(44).max(BiomeNoise.glacialCirquesIceSurface(seed).addConstant(44))).surface(IceSheetSurfaceBuilder.ICE_SHEET_MOUNTAINS).spawnable().type(RiverBlendType.CAVE).noSandyRiverShores().shore());
    public static final BiomeExtension ICE_SHEET_OCEANIC_MOUNTAINS_EDGE = register("ice_sheet_oceanic_mountains_edge", builder().heightmap(seed -> BiomeNoise.glacialCirques(seed).max(BiomeNoise.glacialOceanicCirquesIceSurface(seed))).surface(IceSheetSurfaceBuilder.ICE_SHEET_OCEANIC_MOUNTAINS).spawnable().type(RiverBlendType.CAVE).noSandyRiverShores().shore().setCliffBaseHeight(-16));
    public static final BiomeExtension MELTWATER_LAKE = register("meltwater_lake", builder().heightmap(BiomeNoise::lake).surface(NormalSurfaceBuilder.INSTANCE).aquiferHeightOffset(-16).type(BiomeBlendType.LAKE).type(RiverBlendType.WIDE).noRivers().shore());
    public static final BiomeExtension ICE_SHEET_SHORE = register("ice_sheet_shore", builder().heightmap(BiomeNoise::glacialOceanicBase).surface(IceSheetSurfaceBuilder.OCEANIC).spawnable().type(RiverBlendType.TALL_CANYON).noSandyRiverShores().shore().setCliffBaseHeight(-16));

    // Glaciated Biomes
    // TODO: Consider removing active variant for glaciated and ice sheet SV's?
    public static final BiomeExtension GLACIATED_MOUNTAINS = register("glaciated_mountains", builder().heightmap(seed -> BiomeNoise.glacialCirques(seed).addConstant(44).max(BiomeNoise.glacialCirquesIceSurface(seed).addConstant(44))).surface(IceSheetSurfaceBuilder.GLACIATED_MOUNTAINS).spawnable().type(RiverBlendType.CAVE).noSandyRiverShores());
    public static final BiomeExtension GLACIATED_OCEANIC_MOUNTAINS = register("glaciated_oceanic_mountains", builder().heightmap(seed -> BiomeNoise.glacialCirques(seed).max(BiomeNoise.glacialOceanicCirquesIceSurface(seed))).surface(IceSheetSurfaceBuilder.GLACIATED_OCEANIC_MOUNTAINS).spawnable().type(RiverBlendType.CAVE).noSandyRiverShores());
    ...
    // Montane biomes
    public static final BiomeExtension GLACIALLY_CARVED_MOUNTAINS = register("glacially_carved_mountains", builder().heightmap(seed -> BiomeNoise.glacialCirques(seed).addConstant(44)).surface(MountainSurfaceBuilder.INSTANCE).spawnable().type(RiverBlendType.CAVE).noSandyRiverShores());
    public static final BiomeExtension GLACIALLY_CARVED_OCEANIC_MOUNTAINS = register("glacially_carved_oceanic_mountains", builder().heightmap(seed -> BiomeNoise.glacialCirques(seed)).surface(MountainSurfaceBuilder.INSTANCE).spawnable().type(RiverBlendType.CAVE).noSandyRiverShores());
