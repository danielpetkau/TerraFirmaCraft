...
public class BlackBearModel extends HierarchicalAnimatedModel<Predator>
{
    ...
    public static LayerDefinition createBodyLayer()
    {
        ...
        PartDefinition body_r1 = body.addOrReplaceChild("body_r1", CubeListBuilder.create().texOffs(0, 0).addBox(-9.5F, -1.0F, -9.5F, 19.0F, 14.0F, 16.0F, new CubeDeformation(0.0F))
            .texOffs(0, 30).addBox(-8.5F, -13.0F, -9.5F, 17.0F, 12.0F, 15.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, -7.0F, -10.0F, 1.5708F, 0.0F, 0.0F));

        PartDefinition body_r2 = body.addOrReplaceChild("body_r2", CubeListBuilder.create().texOffs(0, 57).addBox(-9.5F, -1.0F, 3.5F, 19.0F, 14.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, 9.0F, -10.0F, 1.5708F, 0.0F, 0.0F));

        PartDefinition body_r3 = body.addOrReplaceChild("body_r3", CubeListBuilder.create().texOffs(49, 30).addBox(-8.5F, -13.0F, 2.5F, 17.0F, 12.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, 8.0F, -10.0F, 1.5708F, 0.0F, 0.0F));

        PartDefinition right_front_leg = body.addOrReplaceChild("right_front_leg", CubeListBuilder.create().texOffs(80, 1).addBox(-2.0F, 0.0F, -3.0F, 6.0F, 9.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(-5.0F, 2.0F, -19.0F));

        PartDefinition left_front_leg = body.addOrReplaceChild("left_front_leg", CubeListBuilder.create().texOffs(54, 0).addBox(-4.0F, 0.0F, -3.0F, 6.0F, 9.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(6.0F, 2.0F, -19.0F));

        PartDefinition head = body.addOrReplaceChild("head", CubeListBuilder.create().texOffs(55, 48).addBox(-5.5F, -5.0F, -9.0F, 11.0F, 10.0F, 9.0F, new CubeDeformation(0.0F))
            .texOffs(44, 67).addBox(-3.5F, 0.0F, -11.0F, 7.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.5F, -5.5F, -22.0F));

        PartDefinition bone2 = head.addOrReplaceChild("bone2", CubeListBuilder.create().texOffs(0, 5).addBox(-2.5F, -3.0F, -1.0F, 4.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(-4.0F, -5.0F, -5.0F));

        PartDefinition bone = head.addOrReplaceChild("bone", CubeListBuilder.create().texOffs(0, 0).addBox(-1.5F, -3.0F, -1.0F, 4.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(4.0F, -5.0F, -5.0F));

        PartDefinition right_hind_leg = body1.addOrReplaceChild("right_hind_leg", CubeListBuilder.create().texOffs(80, 1).addBox(-3.0F, 0.0F, -3.0F, 6.0F, 9.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(-5.5F, 8.0F, 10.0F));

        PartDefinition left_hind_leg = body1.addOrReplaceChild("left_hind_leg", CubeListBuilder.create().texOffs(54, 0).addBox(-3.0F, 0.0F, -3.0F, 6.0F, 9.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(5.5F, 8.0F, 10.0F));

        return LayerDefinition.create(meshdefinition, 128, 128);
    }

    public static final AnimationDefinition BLACK_BEAR_RUN = AnimationDefinition.Builder.withLength(0.68F).looping()
    ...
    public static final AnimationDefinition BLACK_BEAR_SLEEP = AnimationDefinition.Builder.withLength(3.2083F).looping()
        .addAnimation("right_front_leg", new AnimationChannel(AnimationChannel.Targets.ROTATION,
            new Keyframe(0.0F, KeyframeAnimations.degreeVec(-89.8856F, -9.9136F, -1.3184F), AnimationChannel.Interpolations.LINEAR),
            new Keyframe(1.5833F, KeyframeAnimations.degreeVec(-82.39F, -9.91F, -1.32F), AnimationChannel.Interpolations.LINEAR),
            new Keyframe(2.2083F, KeyframeAnimations.degreeVec(-80.305F, -9.9114F, -1.3194F), AnimationChannel.Interpolations.LINEAR),
        ...
        .addAnimation("right_front_leg", new AnimationChannel(AnimationChannel.Targets.POSITION,
            ...
            new Keyframe(1.5833F, KeyframeAnimations.posVec(0.0F, 1.0F, -2.0F), AnimationChannel.Interpolations.LINEAR),
            new Keyframe(3.2083F, KeyframeAnimations.posVec(0.0F, 1.0F, -2.0F), AnimationChannel.Interpolations.LINEAR)
        ))
        .addAnimation("left_front_leg", new AnimationChannel(AnimationChannel.Targets.ROTATION,
            new Keyframe(0.0F, KeyframeAnimations.degreeVec(-89.8856F, 9.9136F, 1.3184F), AnimationChannel.Interpolations.LINEAR),
            new Keyframe(1.5833F, KeyframeAnimations.degreeVec(-82.39F, 9.91F, 1.32F), AnimationChannel.Interpolations.LINEAR),
        ...
        .addAnimation("left_hind_leg", new AnimationChannel(AnimationChannel.Targets.ROTATION,
            ...
            new Keyframe(1.5833F, KeyframeAnimations.degreeVec(-90.0F, 2.5F, 0.0F), AnimationChannel.Interpolations.LINEAR),
            new Keyframe(3.2083F, KeyframeAnimations.degreeVec(-90.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR)
        ))
        .addAnimation("left_hind_leg", new AnimationChannel(AnimationChannel.Targets.POSITION,
        ...
        .addAnimation("head", new AnimationChannel(AnimationChannel.Targets.ROTATION,
            ...
            new Keyframe(1.0833F, KeyframeAnimations.degreeVec(77.5F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
            new Keyframe(3.2083F, KeyframeAnimations.degreeVec(72.5F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR)
        ))
        .addAnimation("head", new AnimationChannel(AnimationChannel.Targets.POSITION,
            new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, 2.0F, 1.0F), AnimationChannel.Interpolations.LINEAR),
            new Keyframe(3.2083F, KeyframeAnimations.posVec(0.0F, 2.0F, 1.0F), AnimationChannel.Interpolations.LINEAR)
        ))
        .addAnimation("right_hind_leg", new AnimationChannel(AnimationChannel.Targets.ROTATION,
            new Keyframe(0.0F, KeyframeAnimations.degreeVec(-90.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
            new Keyframe(1.5833F, KeyframeAnimations.degreeVec(-90.0F, -2.5F, 0.0F), AnimationChannel.Interpolations.LINEAR),
    ...
    public static final AnimationDefinition BLACK_BEAR_SWIM = AnimationDefinition.Builder.withLength(1.5F).looping()
        .addAnimation("right_front_leg", new AnimationChannel(AnimationChannel.Targets.ROTATION,
            new Keyframe(0.0F, KeyframeAnimations.degreeVec(-91.3413F, 2.6529F, 0.0931F), AnimationChannel.Interpolations.LINEAR),
            ...
            new Keyframe(1.5F, KeyframeAnimations.degreeVec(-91.3413F, 2.6529F, 0.0931F), AnimationChannel.Interpolations.LINEAR)
        ))
        .addAnimation("right_front_leg", new AnimationChannel(AnimationChannel.Targets.POSITION,
        ...
        .addAnimation("left_hind_leg", new AnimationChannel(AnimationChannel.Targets.ROTATION,
            ...
            new Keyframe(0.75F, KeyframeAnimations.degreeVec(33.2218F, 3.2573F, -3.6829F), AnimationChannel.Interpolations.LINEAR),
    ...
    public static final AnimationDefinition BLACK_BEAR_ATTACK = AnimationDefinition.Builder.withLength(1.0F)
        .addAnimation("body1", new AnimationChannel(AnimationChannel.Targets.ROTATION,
            new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
            new Keyframe(1.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR)
        ))
        ...
        .addAnimation("right_front_leg", new AnimationChannel(AnimationChannel.Targets.ROTATION,
            ...
            new Keyframe(0.5833F, KeyframeAnimations.degreeVec(-63.5603F, -8.7022F, -24.2299F), AnimationChannel.Interpolations.LINEAR),
            new Keyframe(0.625F, KeyframeAnimations.degreeVec(-62.4971F, -17.6196F, -28.883F), AnimationChannel.Interpolations.LINEAR),
            new Keyframe(1.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR)
        ))
        .addAnimation("right_front_leg", new AnimationChannel(AnimationChannel.Targets.POSITION,
            new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
            new Keyframe(0.2917F, KeyframeAnimations.posVec(-3.0F, 0.0F, -2.0F), AnimationChannel.Interpolations.LINEAR),
            new Keyframe(0.4167F, KeyframeAnimations.posVec(-2.0F, 4.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
    ...
    public static final AnimationDefinition BLACK_BEAR_CRAWL = AnimationDefinition.Builder.withLength(1.4583F).looping()
        .addAnimation("body1", new AnimationChannel(AnimationChannel.Targets.ROTATION,
        ...
        .addAnimation("right_front_leg", new AnimationChannel(AnimationChannel.Targets.ROTATION,
            ...
            new Keyframe(1.4583F, KeyframeAnimations.degreeVec(45.0F, 0.0F, 90.0F), AnimationChannel.Interpolations.LINEAR)
        ))
        .addAnimation("right_front_leg", new AnimationChannel(AnimationChannel.Targets.POSITION,
            new Keyframe(0.0F, KeyframeAnimations.posVec(-1.0F, 4.0F, -1.0F), AnimationChannel.Interpolations.LINEAR),
            new Keyframe(0.744F, KeyframeAnimations.posVec(-1.0F, 4.0F, -1.0F), AnimationChannel.Interpolations.LINEAR),
            new Keyframe(1.4583F, KeyframeAnimations.posVec(-1.0F, 4.0F, -1.0F), AnimationChannel.Interpolations.LINEAR)
        ))
        .addAnimation("left_front_leg", new AnimationChannel(AnimationChannel.Targets.ROTATION,
            ...
            new Keyframe(1.4583F, KeyframeAnimations.degreeVec(-47.5F, 0.0F, -90.0F), AnimationChannel.Interpolations.LINEAR)
        ))
        .addAnimation("left_front_leg", new AnimationChannel(AnimationChannel.Targets.POSITION,
            new Keyframe(0.0F, KeyframeAnimations.posVec(2.0F, 4.0F, -2.0F), AnimationChannel.Interpolations.LINEAR),
            new Keyframe(0.744F, KeyframeAnimations.posVec(1.0F, 4.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
            new Keyframe(1.4583F, KeyframeAnimations.posVec(2.0F, 4.0F, -2.0F), AnimationChannel.Interpolations.LINEAR)
        ))
        .addAnimation("head", new AnimationChannel(AnimationChannel.Targets.ROTATION,
        ...
        .addAnimation("head", new AnimationChannel(AnimationChannel.Targets.POSITION,
            ...
            new Keyframe(1.2083F, KeyframeAnimations.posVec(0.0F, -1.05F, 0.0F), AnimationChannel.Interpolations.LINEAR),
        ...
        .addAnimation("bone", new AnimationChannel(AnimationChannel.Targets.ROTATION,
            new Keyframe(0.0F, KeyframeAnimations.degreeVec(10.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
            new Keyframe(0.2083F, KeyframeAnimations.degreeVec(-6.67F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
        ...
        .addAnimation("right_hind_leg", new AnimationChannel(AnimationChannel.Targets.ROTATION,
            ...
            new Keyframe(0.75F, KeyframeAnimations.degreeVec(-25.2929F, -3.5979F, 90.8937F), AnimationChannel.Interpolations.LINEAR),
            new Keyframe(0.8929F, KeyframeAnimations.degreeVec(-44.3548F, 0.0F, 90.0F), AnimationChannel.Interpolations.LINEAR),
            new Keyframe(1.4583F, KeyframeAnimations.degreeVec(55.0F, 0.0F, 90.0F), AnimationChannel.Interpolations.LINEAR)
        ))
        .addAnimation("right_hind_leg", new AnimationChannel(AnimationChannel.Targets.POSITION,
            new Keyframe(0.0F, KeyframeAnimations.posVec(-1.0F, -1.0F, 2.0F), AnimationChannel.Interpolations.LINEAR),
            new Keyframe(0.744F, KeyframeAnimations.posVec(-2.0F, -1.0F, -1.0F), AnimationChannel.Interpolations.LINEAR),
            new Keyframe(1.4583F, KeyframeAnimations.posVec(-1.0F, -1.0F, 2.0F), AnimationChannel.Interpolations.LINEAR)
        ))
        .addAnimation("left_hind_leg", new AnimationChannel(AnimationChannel.Targets.ROTATION,
            ...
            new Keyframe(1.4583F, KeyframeAnimations.degreeVec(-32.5F, 0.0F, -90.0F), AnimationChannel.Interpolations.LINEAR)
        ))
        .addAnimation("left_hind_leg", new AnimationChannel(AnimationChannel.Targets.POSITION,
            new Keyframe(0.0F, KeyframeAnimations.posVec(2.0F, -1.0F, -3.0F), AnimationChannel.Interpolations.LINEAR),
            new Keyframe(0.744F, KeyframeAnimations.posVec(1.0F, -1.0F, 2.0F), AnimationChannel.Interpolations.LINEAR),
            new Keyframe(1.4583F, KeyframeAnimations.posVec(2.0F, -1.0F, -3.0F), AnimationChannel.Interpolations.LINEAR)
        ))
        .build();

    public static final AnimationDefinition BLACK_BEAR_WALK = AnimationDefinition.Builder.withLength(2.2528F).looping()
        .addAnimation("body1", new AnimationChannel(AnimationChannel.Targets.ROTATION,
        ...
        .addAnimation("right_hind_leg", new AnimationChannel(AnimationChannel.Targets.ROTATION,
            ...
            new Keyframe(1.1264F, KeyframeAnimations.degreeVec(22.5F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
            new Keyframe(1.8148F, KeyframeAnimations.degreeVec(-10.9039F, 3.9386F, 19.6239F), AnimationChannel.Interpolations.LINEAR),
        ...
        .addAnimation("right_hind_leg", new AnimationChannel(AnimationChannel.Targets.POSITION,
            ...
            new Keyframe(1.1264F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
            new Keyframe(1.627F, KeyframeAnimations.posVec(0.0F, 4.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
        ...
        .addAnimation("left_hind_leg", new AnimationChannel(AnimationChannel.Targets.ROTATION,
            new Keyframe(0.0F, KeyframeAnimations.degreeVec(22.5F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
            new Keyframe(0.6884F, KeyframeAnimations.degreeVec(-13.7603F, -4.948F, -19.4026F), AnimationChannel.Interpolations.LINEAR),
            new Keyframe(0.9387F, KeyframeAnimations.degreeVec(-22.5F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
            new Keyframe(2.2528F, KeyframeAnimations.degreeVec(22.5F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR)
        ))
        .addAnimation("left_hind_leg", new AnimationChannel(AnimationChannel.Targets.POSITION,
            new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
            new Keyframe(0.5632F, KeyframeAnimations.posVec(0.0F, 4.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
