...
{
    HIT_LIGHT(-3, 53, 50, 64, 240),
    HIT_MEDIUM(-6, 71, 50, 80, 240),
    HIT_HARD(-9, 53, 68, 96, 240),
    DRAW(-15, 71, 68, 112, 240),
    PUNCH(2, 89, 50, 0, 240),
    BEND(7, 107, 50, 16, 240),
    UPSET(13, 89, 68, 32, 240),
    SHRINK(16, 107, 68, 48, 240);
