...
public class HeatingBehaviorTests
{
    ...
    {
        checkTicksSpentMoltenAfterPitKiln(helper, 505, false, false, Metal.COPPER, new ItemStack(TFCBlocks.SMALL_ORES.get(Ore.NATIVE_COPPER).get()));
    }

    @MyTest(unitTest = true)
    public void checkTicksToCool100mBCopperInSmallVessel(GameTestHelper helper)
    {
        checkTicksSpentMoltenAfterPitKiln(helper, 720, false, false, Metal.COPPER, new ItemStack(TFCItems.GRADED_ORES.get(Ore.NATIVE_COPPER).get(Ore.Grade.NORMAL).get(), 4));
    }

    @MyTest(unitTest = true)
    public void checkTicksToCool560mBCopperInSmallVessel(GameTestHelper helper)
    {
        checkTicksSpentMoltenAfterPitKiln(helper, 1824, false, false, Metal.COPPER, new ItemStack(TFCItems.GRADED_ORES.get(Ore.NATIVE_COPPER).get(Ore.Grade.RICH).get(), 16));
    }
    ...
    {
        final ItemStack copper16 = new ItemStack(TFCItems.GRADED_ORES.get(Ore.NATIVE_COPPER).get(Ore.Grade.RICH).get(), 16);
        checkTicksSpentMoltenAfterPitKiln(helper, 5856, false, false, Metal.COPPER, copper16, copper16, copper16, copper16);
    }
    ...
    {
        final ItemStack copper16 = new ItemStack(TFCItems.GRADED_ORES.get(Ore.NATIVE_COPPER).get(Ore.Grade.RICH).get(), 16);
        checkTicksSpentMoltenAfterPitKiln(helper, 560, true, true, Metal.COPPER, copper16);
    }
    ...
    {
        final ItemStack copper16 = new ItemStack(TFCItems.GRADED_ORES.get(Ore.NATIVE_COPPER).get(Ore.Grade.RICH).get(), 16);
        checkTicksSpentMoltenAfterPitKiln(helper, 2219, false, true, Metal.COPPER, copper16, copper16, copper16, copper16);
    }
    ...
    {
        final ItemStack copper100mB = new ItemStack(TFCItems.GRADED_ORES.get(Ore.NATIVE_COPPER).get(Ore.Grade.NORMAL).get(), 4);
        checkTicksSpentMoltenAfterPitKiln(helper, 100, true, true, Metal.COPPER, copper100mB);
    }
    ...
    public void checkPitKilnCanMelt100mBBronzeInSmallVessel(GameTestHelper helper)
    {
        ...
        checkTicksSpentMoltenAfterPitKiln(helper, 100, true, true, Metal.BRONZE, copper90mB, tin10mB);
    }
    ...
    public void checkPitKilnCanMelt100mBBismuthBronzeInSmallVessel(GameTestHelper helper)
    {
        ...
        checkTicksSpentMoltenAfterPitKiln(helper, 100, true, true, Metal.BISMUTH_BRONZE, copper50mB, zinc30mB, bismuth20mB);
    }
    ...
    public void checkPitKilnCanMelt100mBBlackBronzeInSmallVessel(GameTestHelper helper)
    {
        ...
        checkTicksSpentMoltenAfterPitKiln(helper, 100, true, true, Metal.BLACK_BRONZE, copper60mB, silver20mB, gold20mB);
    }
    ...
    public void checkPitKilnCanMeltBronzeInSmallVessel(GameTestHelper helper)
    {
        ...
        checkTicksSpentMoltenAfterPitKiln(helper, 1540, true, true, Metal.BRONZE, copper16, copper16, copper8, tin4);
    }
    ...
    public void checkPitKilnCanMeltBismuthBronzeInSmallVessel(GameTestHelper helper)
    {
        ...
        checkTicksSpentMoltenAfterPitKiln(helper, 1750, true, true, Metal.BISMUTH_BRONZE, copper16, copper10, bismuth10, zinc14);
    }
    ...
    public void checkPitKilnCanMeltBlackBronzeInSmallVessel(GameTestHelper helper)
    {
        ...
        checkTicksSpentMoltenAfterPitKiln(helper, 2235, false, true, Metal.BLACK_BRONZE, copper16, copper16, gold16, silver16);
    }
    ...
    public void checkPitKilnCanFirePottery(GameTestHelper helper)
    {
        ...
        final IItemHandler pitKilnInventory = pitKiln.getInventory();
    ...
    {
        assertEquals(1358, ticksRequiredToBeNotWorkable(new ItemStack(TFCItems.METAL_ITEMS.get(Metal.BRONZE).get(Metal.ItemType.INGOT).get())));
    }

    @MyTest(unitTest = true)
    public void checkBronzeDoubleIngotTimeSpentWorkable(GameTestHelper helper)
    {
        assertEquals(2715, ticksRequiredToBeNotWorkable(new ItemStack(TFCItems.METAL_ITEMS.get(Metal.BRONZE).get(Metal.ItemType.DOUBLE_INGOT).get())));
    }

    @MyTest(unitTest = true)
    public void checkIronIngotTimeSpentWorkable(GameTestHelper helper)
    {
        assertEquals(2193, ticksRequiredToBeNotWorkable(new ItemStack(TFCItems.METAL_ITEMS.get(Metal.WROUGHT_IRON).get(Metal.ItemType.INGOT).get())));
    }

    @MyTest(unitTest = true)
    public void checkIronDoubleIngotTimeSpentWorkable(GameTestHelper helper)
    {
        assertEquals(4386, ticksRequiredToBeNotWorkable(new ItemStack(TFCItems.METAL_ITEMS.get(Metal.WROUGHT_IRON).get(Metal.ItemType.DOUBLE_INGOT).get())));
    }
    ...
    private void checkTicksSpentMoltenAfterPitKiln(GameTestHelper helper, int expectedTicks, boolean expectEmpty, boolean whileDraining, Metal moltenMetal, ItemStack... contents)
    {
        final PitKilnBlockEntity pitKiln = pitKiln(helper);
        final IItemHandler pitKilnInventory = pitKiln.getInventory();
        ...
        try (CalendarTransaction tr = Calendars.SERVER.transaction())
        {
            ...
            final ItemStack outputStack = pitKilnInventory.extractItem(0, 1, false);
            final Vessel outputVessel = Vessel.get(outputStack);
            ...
            {
                tr.add(1);
                assertTrue(outputVessel.isMolten(), "Not molten after " + i + " ticks, temperature is " + outputVessel.getTemperature() + " with content molten=" + outputVessel.isMolten());
                if (whileDraining)
                {
            ...
            {
                assertTrue(vessel.isInventory(), "Vessel still contains metal, expected empty, at temperature " + outputVessel.getTemperature());
            }
            else
            {
                // Assert not molten anymore
                assertFalse(vessel.isMolten(), "Still molten after " + expectedTicks + " ticks, the temperature is " + outputVessel.getTemperature() + " with content molten=" + outputVessel.isMolten());
            }
        }
    }
