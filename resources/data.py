...
def generate(rm: ResourceManager):
    ...
    mob_loot(rm, 'wildebeest', 'tfc:food/venison', 8, 14, 'small', hide_chance=0.8, bones=3, not_predated=True)
    mob_loot(rm, 'bison', 'tfc:food/bison', 12, 20, 'large', bones=10, not_predated=True)
