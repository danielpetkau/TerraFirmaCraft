...
DEFAULT_LANG = {
    ...
    **dict(('subtitles.entity.tfc.%s.hurt' % fish, '%s hurts' % fish.title().replace('_', ' ')) for fish in (*SIMPLE_FRESHWATER_FISH, 'manatee', 'jellyfish')),
    ...
    'tfc.tooltop.rotation.cannot_rotate.too_few_blades': 'Cannot rotate with only one blade!',
    'tfc.tooltop.rotation.cannot_rotate.obstructed': 'Cannot rotate! Obstructed!',
