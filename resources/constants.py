...
CROPS: dict[str, Crop] = {
    'cassava': Crop('default', 'legume', 6, 10.4, 40, 260, 500, 4, 36, 45, 100, -50, 40, 20, 'normal', None),
    'green_bean': Crop('double_stick', 'legume', 8, -4, 19.4, 150, 410, -11, 22, 25, 90, -80, 50, 40, 'normal', None),
    'lentil': Crop('default', 'legume', 6, -7.6, 19.4, 75, 190, -15, 22, 15, 50, -80, 20, 20, None, None),
    'peanut': Crop('default', 'legume', 6, 12.2, 40, 130, 360, 6, 36, 20, 80, -90, 50, 50, None, None),
    'soybean': Crop('default', 'legume', 7, -9.4, 15.8, 160, 410, -17, 19, 25, 90, -80, 60, 30, 'normal', None),
    'barley': Crop('default', 'cereal', 8, -9.4, 17.6, 70, 310, -17, 21, 10, 70, 75, -20, -20, None, 'edge'),
    'oat': Crop('default', 'cereal', 8, -9.4, 15.8, 140, 400, -17, 19, 25, 85, 100, -35, -25, None, 'edge'),
    'rye': Crop('default', 'cereal', 8, -9.4, 8.6, 100, 350, -17, 13, 15, 80, 100, -20, -40, None, 'edge'),
    'maize': Crop('double', 'cereal', 6, -9.4, 23., 300, 500, -17, 25, 50, 100, 90, -25, -25, None, 'edge'),
    'wheat': Crop('default', 'cereal', 8, -9.4, 15.8, 100, 400, -17, 19, 15, 85, 100, -30, -30, None, 'edge'),
    'rice': Crop('default', 'cereal', 8, 8.6, 40, 200, 500, 2, 36, 35, 100, 40, 30, 30, 'edge', None),
    'beet': Crop('default', 'vegetable', 6, -13, 23., 70, 300, -21, 25, 10, 70, 40, 30, 50, None, None),
    'cabbage': Crop('default', 'vegetable', 6, -13, 23., 60, 280, -21, 25, 10, 65, 50, 20, 40, None, None),
    'carrot': Crop('default', 'vegetable', 5, -13, 23., 100, 400, -21, 25, 15, 85, 50, 30, 40, None, None),
    'garlic': Crop('default', 'vegetable', 5, -5.8, 15.8, 60, 310, -13, 19, 10, 70, 40, 20, 50, None, None),
    'onion': Crop('default', 'vegetable', 7, -7.6, 21.2, 100, 390, -15, 24, 15, 85, 40, 40, 40, None, None),
    'potato': Crop('default', 'vegetable', 7, -9.4, 15.8, 200, 420, -17, 19, 35, 90, 40, 20, 60, None, None),
    'squash': Crop('default', 'vegetable', 8, -9.4, 19.4, 90, 390, -17, 22, 15, 85, 25, 45, 50, 'normal', None),
    'tomato': Crop('double_stick', 'vegetable', 8, 1.4, 40, 120, 390, -5, 36, 20, 85, 40, 50, 60, 'normal', None),
    'red_bell_pepper': Crop('pickable', 'pickable vegetable', 7, 12.2, 40, 190, 450, 6, 36, 30, 95, 30, 40, 50, None, None),
    'yellow_bell_pepper': Crop('pickable', 'pickable vegetable', 7, 12.2, 40, 190, 450, 6, 36, 30, 95, 30, 40, 50, None, None),
    'pumpkin': Crop('spreading', 'spreading vegetable', 8, -9.4, 23., 120, 390, -17, 25, 20, 85, 40, 30, 60, None, None),
    'melon': Crop('spreading', 'spreading vegetable', 8, 5, 40, 200, 500, -1, 36, 35, 100, 30, 40, 65, None, None),
    'canola': Crop('default', 'cover', 6, -13, 3.2, 120, 320, -35, -5, 20, 75, -30, -60, -100, None, 'edge'),
    'radish': Crop('default', 'cover', 6, -11.2, 6.8, 190, 410, -33, -1, 30, 90, -50, -100, -60, None, None),
    'alfalfa': Crop('default', 'cover', 6, -14.8, 5, 240, 480, -37, -3, 40, 100, -80, -50, -60, None, 'edge'),
    'jute': Crop('double', 'misc', 6, 1.4, 19.4, 100, 410, -5, 22, 15, 90, 60, 40, -40, None, None),
    'papyrus': Crop('double', 'misc', 6, 12.2, 40, 310, 500, 6, 36, 50, 100, 60, -40, 40, None, None),
    'sugarcane': Crop('double', 'misc', 8, 17.6, 40, 160, 500, 12, 36, 25, 100, 50, 50, 50, None, None),
}
