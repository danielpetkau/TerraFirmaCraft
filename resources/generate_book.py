...
def make_book(rm: ResourceManager, i18n: I18n, local_instance: bool = False, reverse_translate: bool = False):
    ...
    book.category('mechanics', 'Advanced Mechanics', 'Advanced sections of the tech tree, from the first pickaxe, all the way to colored steel.$(br2)$(br)$(bold)Note:$() you can search entries simply by starting to type anywhere!', 'tfc:metal/axe/red_steel', entries=(
        ...
        entry('advanced_building_materials', 'Advanced Materials', 'tfc:brick/rhyolite', pages=(
            ...
            text('$(br) 1. $(l:mechanics/advanced_building_materials#alabaster)Plaster$()$(br) 2. $(l:mechanics/advanced_building_materials#bricks_and_mortar)Bricks and Mortar$()$(br)', title='Contents'),
            page_break(),
            # Plaster
            text('Plaster is a building block made from $(l:the_world/ores_and_minerals#gypsum)Gypsum$(). Plaster can be made by directly crafting with $(l:the_world/ores_and_minerals#gypsum)Gypsum$(), however it can be made more efficiently by sealing some $(l:the_world/ores_and_minerals#gypsum)Gypsum$() with 100 mB of $(thing)Limewater$() in a barrel.', title='Plaster').anchor('alabaster').link('tfc:alabaster/raw', 'tfc:alabaster/polished'),
