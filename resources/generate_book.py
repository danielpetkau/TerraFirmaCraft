...
def make_book(rm: ResourceManager, i18n: I18n, local_instance: bool = False, reverse_translate: bool = False):
    ...
    book.category('the_world', 'The World', 'All about the natural world around you.', 'tfc:grass/entisol', is_sorted=True, entries=(
        ...
        entry('climate', 'Calendar and Climate', 'tfc:textures/gui/book/icons/thermometer.png', pages=(
            ...
            page_break(),
            text('Another tab on the main inventory screen is the $(thing)Climate$() screen. This one shows information about the current location$(br2)From top to bottom, the screen displays the $(l:https://en.wikipedia.org/wiki/K%C3%B6ppen_climate_classification)Local Climate$(), the $(thing)Average Annual Temperature$(), the $(thing)Average Annual Rainfall$(), the peak rainfall, the season when the peak occurs, and the current temperature.', title='Climate').anchor('climate'),
    ...
    book.category('mechanics', 'Advanced Mechanics', 'Advanced sections of the tech tree, from the first pickaxe, all the way to colored steel.$(br2)$(br)$(bold)Note:$() you can search entries simply by starting to type anywhere!', 'tfc:metal/axe/red_steel', entries=(
        ...
        entry('animal_husbandry', 'Animal Husbandry', 'minecraft:egg', pages=(
            ...
            text('$(thing)Frogs$() spawn in $(l:the_world/climate#temperature)temperatures$() above -13°C, and at least 150mm of $(l:the_world/climate#rainfall)rainfall$(). They are can be familiarized, after which they will lay eggs in fresh water at random. They will eat fish and spider eyes. ', title='Frogs').anchor('frog'),
