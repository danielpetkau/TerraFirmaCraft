...
def generate(rm: ResourceManager):
    ...
    biome(rm, 'sea_stumps', 'beach', ocean_features=True)
    biome(rm, 'terrace_upper', 'beach', ocean_features=True)
    biome(rm, 'terrace_lower', 'beach', ocean_features=True)
    biome(rm, 'setback_cliffs', 'beach', ocean_features=True)
    biome(rm, 'coastal_dunes', 'beach', ocean_features=True)
    biome(rm, 'rocky_shores', 'beach', ocean_features=True)
    biome(rm, 'embayments', 'beach', ocean_features=True)
